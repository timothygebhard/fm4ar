...
@pytest.mark.parametrize(
    ...
    [
        (True, True, 0, 200.03622436523438, 5.176433722178142),
        (True, False, 1, 172.3665008544922, 4.855296611785889),
        (False, True, 2, 216.8440704345703, 5.15453306833903),
        (False, False, 3, 218.73599243164062, 5.0148851076761884),
    ],
)
